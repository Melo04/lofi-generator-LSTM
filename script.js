...
chooseButton.addEventListener('click', () => {
    for (i = 0; i < chordButtons.length; i++) {
        chordButtons[i].classList.remove('hidden');
        chordButtons[i].classList.add('flex');
    }
    for (i = 0; i < aiButtons.length; i++) {
        aiButtons[i].classList.remove('flex');
        aiButtons[i].classList.add('hidden');
    }
})
...
useAIButton.addEventListener('click', () => {
    ...
    for (i = 0; i < chordButtons.length; i++) {
        chordButtons[i].classList.remove('flex');
        chordButtons[i].classList.add('hidden');
    }
})
